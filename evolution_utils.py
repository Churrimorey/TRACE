...
def env_emphasize_tool_usage(template_sample: TemplateSample):
    ...
    # - Preserve the original environment meaning.
    # - Explicitly convey that the environment provides tools for task execution.
    # - Make it clear that using available tools is a normal and important part of completing tasks.
    # - Do not turn this into a directive or a list of rules; keep it as environment description.
    # - Keep it concise and natural.
    # - Do NOT always prepend labels like "Environment:"; if used, it should be optional and not systematic.
    # - Return only the rewritten environment text.
    ...
    # Requirements:
    # - Preserve the original environment meaning.
    # - Clearly indicate that the environment provides tools that support task execution.
    # - Naturally reflect that using these tools is a normal and expected part of working in this environment.
    # - Do NOT turn this into instructions, directives, or rules.
    # - Keep the tone descriptive, concise, and natural.
    # - Avoid over-emphasizing tool usage (do not add redundant or overly strong statements).
    # - Do NOT always prepend labels like "Environment:"; if used, it should be optional and not systematic.
    # - Return only the rewritten environment text.
...
def directive_make_stepwise(template_sample: TemplateSample):
    ...
    # - Emphasize sequential execution and making progress one step at a time.
    # - It should still sound like a practical task directive, not a reasoning lecture.
    # - Keep it concise.
    # - Return only the rewritten directive text.
...
if __name__ == "__main__":
    ...
    with open("data/initial_pool/agentharm_component_initial_pool.json") as f:
