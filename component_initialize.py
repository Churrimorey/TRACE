...
if __name__ == "__main__":
    ...
    for component in components:
        output_file_path = f"./data/initial_pool/{dataset}_generated_{component}_pool.json"
    ...
    output_file_path = f"./data/initial_pool/{dataset}_component_initial_pool.json"
    result = {}
    for component in components:
        input_file_path = f"./data/initial_pool/{dataset}_generated_{component}_pool.json"
